...
vim.api.nvim_create_user_command(
    ...
    function()
        ...
        vim.api.nvim_set_hl(0, "@lsp.type.comment", { fg = "#008000" })
        ...
        vim.api.nvim_set_hl(0, "@lsp.type.property.vue", { bg = "#000000" }) -- This is just for testing, to see when LSP has loaded
